...
- When a release adds new release-flow or upgrade-flow capabilities, make sure those highlights are called out in that version's GitHub Release page notes/changelog from the tool repository in both English and Chinese.
